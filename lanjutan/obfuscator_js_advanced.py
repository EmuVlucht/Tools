...
def main():
    ...
    if len(sys.argv) < 2:
        print("Penggunaan:")
        print("  python obfuscator_js_advanced.py <file.js> [output.js]")
        print()
        print("Contoh:")
        print("  python obfuscator_js_advanced.py script.js")
        print("  python obfuscator_js_advanced.py script.js protected.js")
        sys.exit(1)
