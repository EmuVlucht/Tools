...
def main():
    ...
    if len(sys.argv) < 2:
        print("Penggunaan:")
        print("  python obfuscator_advanced.py <file.py> [output.py]")
        print()
        print("Contoh:")
        print("  python obfuscator_advanced.py script.py")
        print("  python obfuscator_advanced.py script.py protected.py")
        sys.exit(1)
